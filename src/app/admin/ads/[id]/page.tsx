...
export default function AdminAdDetailsPage() {
    ...
    const handleViewProfile = () => {
        if (adData) router.push(`/admin/users/${adData.userId}`);
    };
            ...
            <div className="flex flex-1 flex-col">
                <div className="@container/main flex flex-1 flex-col gap-2">
                    <div className="flex flex-col gap-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <Badge className="mt-1 bg-violet-600 hover:bg-violet-700 text-white capitalize">
                                                    {userData.role}
                                                </Badge>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-muted-foreground">Total Ads Purchased</p>
                                                <p className="text-base font-semibold">{userData.totalPurchasedAdsCount}</p>
                                            </div>
                                        </div>
                        ...
                        <AdStatusDetails className="m-4" data={adData} isAdmin={true} />
                    </div>
                </div>
            </div>
        </div>
